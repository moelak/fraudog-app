...
<img
  ...
  alt="Footsteps"
  className="absolute   z-0 w-16 step-2 opacity-0 top-[75%] right-[50%] transform -translate-x-1/2 translate-y-12 rotate-[5deg]"
/> 

<img
  src="/src/assets/footsteps-1.svg"
  alt="Footsteps" 
  className="absolute  z-0 w-16 step-3 opacity-0 top-[90%] right-[68%] transform -translate-x-1/2 translate-y-12"
/>

<img
  src="/src/assets/footsteps-1.svg"
  alt="Footsteps"
  className="absolute   z-0 w-16 step-4 opacity-0 top-[108%] right-[80%] transform -translate-x-1/2 translate-y-12 rotate-[-5deg]"
/>
...
<img
  src="/src/assets/footsteps-1.svg"
  alt="Footsteps"
  className="absolute  footstep z-0 w-24 step-4 opacity-0 top-[125%] right-[90%] transform -translate-x-1/2 translate-y-12 rotate-[-5deg]"
/>
