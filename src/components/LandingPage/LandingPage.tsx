...
{/* <div className="absolute top-1/2  md:left-[75%]  lg:left-[70%] md:w-[500px] md:h-[500px]  lg:w-[600px] lg:h-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-400/20 animate-pulse"></div> */} 
 ...
 <h2 className="text-3xl md:text-4xl font-bold mb-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      src="/src/assets/footsteps-1.svg" 
      alt="Footsteps"
      className="absolute z-0 top-[75%] right-[45%] transform -translate-x-1/2 translate-y-12 w-24 opacity-80 rotate-[-30deg]"
    />  

                       <img
      src="/src/assets/footsteps-1.svg" 
      alt="Footsteps"
      className="absolute z-0 top-[95%] right-[45%] transform -translate-x-1/2 translate-y-12 w-24 opacity-80 rotate-[-30deg]"
    />  
