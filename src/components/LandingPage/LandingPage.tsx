        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left z-10">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
              Our AI agents follow every transaction trail </ln>before fraud strikes.
            </p>
              ...
              <div className="relative w-[768px] h-[768px] mx-auto flex items-center justify-center">
                <div className="relative">
                  ...
                  <img 
                    ...
                    className="relative z-10 w-[540px] h-[540px] object-contain drop-shadow-2xl"
                    style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-start">
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-2xl border border-purple-500/30 backdrop-blur-sm">
                {/* Data Streams */}
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
