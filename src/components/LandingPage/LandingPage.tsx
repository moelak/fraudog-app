...
<img
  ...
  alt="Footsteps"
  className="absolute z-0 w-24 step-1 opacity-0 bottom-42 left-1/2 transform -translate-x-1/2 translate-y-12"
/>
...
{/* <div className="absolute top-1/2  md:left-[75%]  lg:left-[70%] md:w-[500px] md:h-[500px]  lg:w-[600px] lg:h-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-blue-400/20 animate-pulse"></div> */} 
 ...
 <div className="text-center mb-16">
      ...
      src="/src/assets/footsteps-1.svg" 
      alt="Footsteps"
      className="absolute z-0 top-[90%] right-[45%] transform -translate-x-1/2 translate-y-12 w-24 opacity-80 rotate-[-50deg]"
    />  
