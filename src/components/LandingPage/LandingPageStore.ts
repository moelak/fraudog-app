...
export class LandingPageStore {
  brandName = "Frud-dog";
  heroTitle = "Frud-dog";
  heroDescription = "Our business focuses on identifying and stopping fraud before it causes harm. Frud-dog helps businesses detect suspicious activity early, allowing them to take action quickly and protect their operations. Whether it's financial fraud, identity theft, or unusual patterns, Frud-dog is your first line of defense.";
