						...
						<div className='space-y-4'>
							...
							{ruleManagementStore.activeTab === 'deleted' ? (
								...
								<div className='space-y-3'>
									<label className='block text-sm font-medium text-gray-700'>Choose deletion type:</label>
										...
										<label className='flex items-start space-x-3 cursor-pointer'>
											...
											<div className='flex-1'>
												<div className='flex items-center'>
													...
													<span className='text-sm font-medium text-gray-900'>Move to Deleted Rules (Recommended)</span>
												</div>
												<p className='text-xs text-gray-500 mt-1'>
													The rule will be moved to the "Deleted Rules" tab and can be recovered later. The rule will be deactivated but data is
													preserved.
												</p>
											</div>
										</label>
										...
										<label className='flex items-start space-x-3 cursor-pointer'>
											...
											<div className='flex-1'>
												<div className='flex items-center'>
													...
													<span className='text-sm font-medium text-red-900'>Delete Permanently</span>
												</div>
												<p className='text-xs text-red-600 mt-1'>
													⚠️ This action cannot be undone. The rule and all its data will be permanently removed from the database.
												</p>
					...
					<div className='bg-gray-50 px-6 py-4 sm:flex sm:flex-row-reverse'>
						<button
							...
							className={`w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm transition-colors disabled:opacity-50 ${
								deleteType === 'permanent' ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500' : 'bg-yellow-600 hover:bg-yellow-700 focus:ring-yellow-500'
							}`}
						>
